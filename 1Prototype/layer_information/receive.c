...
{
	static short data_num = 0;

	if(data_num == 1){
		if(data[0] == 0x01){
			TYPE0_DATA0 = data[1] & 0x01;
			TYPE0_DATA1 = data[1] & 0x02 >> 1;
			TYPE0_DATA2 = data[1] & 0x04 >> 2;
			TYPE0_DATA3 = data[1] & 0x08 >> 3;
			TYPE0_DATA4 = data[1] & 0x10 >> 4;
			TYPE0_DATA5 = data[1] & 0x20 >> 5;
			TYPE0_DATA6 = data[1] & 0x40 >> 6;
			TYPE0_DATA7 = data[1] & 0x80 >> 7;
			TYPE1_DATA0 = data[2] & 0x01;
			TYPE1_DATA1 = data[2] & 0x02 >> 1;
			TYPE1_DATA2 = data[2] & 0x04 >> 2;
			TYPE1_DATA3 = data[2] & 0x08 >> 3;
			TYPE1_DATA4 = data[2] & 0x10 >> 4;
			TYPE1_DATA5 = data[2] & 0x20 >> 5;
			TYPE1_DATA6 = data[2] & 0x40 >> 6;
			TYPE1_DATA7 = data[2] & 0x80 >> 7;
			data_num = 1;
		}
	}

	if(data_num > MAX_TYPE){
		data_num = 1;
	}
}
